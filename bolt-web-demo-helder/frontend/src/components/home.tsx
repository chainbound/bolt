          ...
          {provider?.selectedAddress && Number(chainId) === HELDER_CHAIN_ID ? (
            ...
            <div className="w-full max-w-6xl pt-4">
              <div className="grid gap-3 border p-4 border-gray-800">
                ...
                <small className="text-sm max-w-3xl">
                  This page will automatically update once you are connected
                </small>
                ...
                <div className="flex w-full justify-center">
                  {provider?.selectedAddress ? (
                      ...
                      onClick={async () => {
                        try {
                          await provider?.request({
                            ...
                            params: [{ chainId: HELDER_CHAIN_ID_HEX }],
                          });
                        } catch (err: any) {
                          const errTyped = err as { message: string };
                          if (
                            errTyped.message.includes("Unrecognized chain ID")
                          ) {
                            await provider?.request({
                              ...
                              params: [
                                {
                                  ...
                                  rpcUrls: ["https://rpc.helder-devnets.xyz/"],
                                },
                              ],
                            });
                          }
                    ...
                    >
                      Switch chain to Helder testnet
                    </Button>
                  ) : (
                    <Button className="max-w-sm" onClick={connect}>
                      Connect wallet
                    </Button>
                  )}
                </div>
